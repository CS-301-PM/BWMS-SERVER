    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('STORES_MANAGER', 'Stores Manager'), ('PROCUREMENT_OFFICER', 'Procurement Officer'), ('CFO', 'Chief Finance Officer'), ('DEPARTMENT_DEAN', 'Department Dean'), ('ADMIN', 'System Admin')], max_length=20)),
